...
<div class="container" style="max-width:520px;">
    <div class="card" style="border-radius:20px;box-shadow:0 2px 12px rgba(0,0,0,0.07);padding:32px 28px;">
        <h2 style="font-size:2rem;font-weight:700;margin-bottom:24px;">Add Item</h2>
        <form action="{{ route('items.store') }}" method="POST" style="display:grid;gap:18px;">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="number" name="price" id="price" min="0" step="0.01" required value="{{ old('price') }}">
            </div>
